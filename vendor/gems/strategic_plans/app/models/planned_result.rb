class PlannedResult < ActiveRecord::Base
  ...
  def create_outcome_url
    Rails.application.routes.url_helpers.strategic_plans_planned_result_outcomes_path(:en,id)
  end

  def url
    Rails.application.routes.url_helpers.strategic_plans_strategic_priority_planned_result_path(:en, strategic_priority_id, id)
  end
