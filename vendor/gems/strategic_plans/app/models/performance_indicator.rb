class PerformanceIndicator < ActiveRecord::Base
  ...
  def index_url
    strategic_plans_strategic_plan_url(:en, strategic_plan.id, {:host => SITE_URL, :protocol => 'https', :performance_indicator_id => id})
  end
  ...
  def create_note_url
    strategic_plans_performance_indicator_notes_path(:en,id)
  end

  def create_reminder_url
    strategic_plans_performance_indicator_reminders_path(:en,id)
  end

  def url
    strategic_plans_activity_performance_indicator_path(:en,activity_id,id)
  end

  def notable_url(notable_id)
    strategic_plans_performance_indicator_note_path('en',id,notable_id)
  end

  def remindable_url(remindable_id)
    strategic_plans_performance_indicator_reminder_path('en',id,remindable_id)
  end
