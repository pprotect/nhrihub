...
module AdvisoryCouncilTermsOfReferenceSetupHelper
  ...
  def setup_terms_of_reference_database
    FactoryBot.create(:terms_of_reference_version, :revision_major => 1, :revision_minor => 0)
    FactoryBot.create(:terms_of_reference_version, :revision_major => 2, :revision_minor => 0)
  end
